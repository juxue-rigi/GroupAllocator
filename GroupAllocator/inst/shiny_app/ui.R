...
survey_ui <- fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      uiOutput("student_inputs")  # Generate name & ID fields according to sub-group size
    ),
    mainPanel(
